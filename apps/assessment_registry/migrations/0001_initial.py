# Generated by Django 3.2.17 on 2023-05-04 10:04
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('donor', models.ManyToManyField(related_name='donor_assessment_reg', to='organization.Organization')),
                ('government', models.ManyToManyField(related_name='gov_assessment_reg', to='organization.Organization')),
                ('international_partners', models.ManyToManyField(related_name='int_partners_assessment_reg', to='organization.Organization')),
                ('lead_organization', models.ManyToManyField(related_name='lead_org_assessment_reg', to='organization.Organization')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('modified_at', models.DateTimeField(auto_now=True)),
                ('client_id', models.CharField(blank=True, default=None, max_length=128, null=True, unique=True)),
                ('document_type', models.IntegerField(choices=[(0, 'Executive summary'), (1, 'Assessment database'), (2, 'Questionaire'), (3, 'Miscellaneous')])),
