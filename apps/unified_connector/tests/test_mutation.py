...
from unified_connector.tests.mock_data.relief_web_mock_data import (
    ...
    def test_unified_connector_create(self):
        def _query_check(minput, **kwargs):
            return self.query_check(
                self.CREATE_UNIFIED_CONNECTOR_MUTATION, minput=minput, variables={"projectId": self.project.id}, **kwargs
            )
...
class UnifiedConnectorCallbackApiTest(TestCase):
    ...
    def test_create_connector(self, RequestHelperMock):
        ...
        # Mock file
        file_1 = SimpleUploadedFile(name="test_image.jpg", content=b"", content_type="image/jpeg")
