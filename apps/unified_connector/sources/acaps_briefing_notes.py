...
class AcapsBriefingNotes(Source):
    ...
    options = [
        ...
        {"key": "field_countries_target_id", "field_type": "select", "title": "Country", "options": COUNTRIES_OPTIONS},
        {
    ...
    def fetch(self, params):
        ...
        for item in content.findAll("div", {"class": "views-row"}):
            try:
                ...
                link_elem = bottomcontent.find("div", {"class": "field-item"})
                ...
                logger.warning("Exception parsing {} with params {}: {}".format(self.URL, params, e.args))
