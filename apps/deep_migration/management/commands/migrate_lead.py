...
import reversion
from deep_migration.models import LeadMigration, ProjectMigration, UserMigration
...
class Command(MigrationCommand):
    ...
    def import_lead(self, data):
        ...
        lead.published_on = data["published_at"] and parse_date(data["published_at"])
        ...
        if data.get("description"):
            ...
            lead.attachment = get_migrated_gallery_file(data["attachment"]["url"])
