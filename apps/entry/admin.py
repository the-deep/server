...
from entry.models import (  # Entry Group
    Attribute,
    Entry,
    EntryComment,
    ExportData,
...
class EntryAdmin(VersionAdmin):
    ...
    list_filter = (AutocompleteFilterFactory("Project", "project"), AutocompleteFilterFactory("User", "created_by"), "created_at")
    autocomplete_fields = (
        "lead",
        "project",
        "created_by",
