...
class TestAnalysisFrameworkFilter(GraphQLTestCase):
    ...
    def test_filter_recently_used(self, now_patch):
        ...
        obtained = set(list(self.filter_class(data={"recently_used": True}).qs.values_list("id", flat=True)))
    ...
    def test_tags_filter(self):
        ...
        for tags, expected in [
            ...
            obtained = self.filter_class(data=dict(tags=[tag.id for tag in tags])).qs
            self.assertQuerySetIdEqual(expected, obtained)
