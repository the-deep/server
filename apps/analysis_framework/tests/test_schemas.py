...
class TestAnalysisFrameworkQuery(GraphQLSnapShotTestCase):
    ...
    def test_recent_analysis_framework(self):
        ...
        self.assertEqual(
            content["data"]["projectExploreStats"]["topActiveFrameworks"][0]["analysisFrameworkId"], str(analysis_framework1.id)
        )
        ...
        self.assertEqual(
            content["data"]["projectExploreStats"]["topActiveFrameworks"][1]["analysisFrameworkId"], str(analysis_framework3.id)
        )
        self.assertEqual(content["data"]["projectExploreStats"]["topActiveFrameworks"][1]["projectCount"], 2)
        self.assertEqual(
            content["data"]["projectExploreStats"]["topActiveFrameworks"][2]["analysisFrameworkId"], str(analysis_framework5.id)
        )
        self.assertEqual(
            content["data"]["projectExploreStats"]["topActiveFrameworks"][3]["analysisFrameworkId"], str(analysis_framework6.id)
        )
        self.assertEqual(
            content["data"]["projectExploreStats"]["topActiveFrameworks"][4]["analysisFrameworkId"], str(analysis_framework4.id)
        )
