...
from .models import AnalysisFrameworkRole, Filter, Widget

AnalysisFrameworkRoleTypeEnum = convert_enum_to_graphene_enum(AnalysisFrameworkRole.Type, name="AnalysisFrameworkRoleTypeEnum")
