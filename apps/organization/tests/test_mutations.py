...
class TestOrganizationMutation(GraphQLTestCase):
    ...
    """
        ...
        minput = dict(title="Test Organization", shortName="Short Name", longName="This is long name")

        def _query_check(minput, **kwargs):
            return self.query_check(self.organization_query, minput=minput, **kwargs)
