...
class Command(BaseCommand):
    ...
    def _get_organization_type_by_relief_web_id(self, relief_web_id):
        if not hasattr(self, "_organization_types"):
            self._organization_types = {org.relief_web_id or "n/a": org for org in OrganizationType.objects.all()}
    ...
    def load_organization(self, org_data):
        ...
        values = {
            ...
            "verified": True,
            "organization_type": self._get_organization_type_by_relief_web_id(fields.get("type", {}).get("id")),
        }
