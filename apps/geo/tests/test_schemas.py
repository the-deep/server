...
class TestGeoSchema(GraphQLTestCase):
    ...
    def test_geo_filters(self):
        ...
        region_1_ad_2_geo_areas = GeoAreaFactory.create_batch(5, admin_level=region_1_admin_level_2, title="XYZ Geô")
        ...
        for name, filters, geo_areas in (
            ("no-filter", dict(), [*region_1_ad_1_geo_areas, *region_1_ad_2_geo_areas, *region_2_ad_1_geo_areas]),
            ("invalid-region-id", dict(regionIds=[str(region3.pk)]), []),
            ("valid-region-id", dict(regionIds=[str(region1.pk)]), [*region_1_ad_1_geo_areas, *region_1_ad_2_geo_areas]),
    ...
    def test_geo_query(self):
        ...
        region_1_ad_2_geo_area_03 = GeoAreaFactory.create(
            title="child (Region 1, AdminLevel 2) Geo Area 03", admin_level=region_1_admin_level_2
        )
            ...
            [
                {
                    ...
                    "parentTitles": [parent.title for parent in parents],
                }
