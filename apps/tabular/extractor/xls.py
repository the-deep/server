...
@LogTime()
def extract(book):
    tmp_filepath = "/tmp/{}".format("".join(random.sample(string.ascii_lowercase, 10)) + ".xls")
    ...
    xlsx_filename = os.path.join(settings.TEMP_DIR, re.sub(r"xls$", "xlsx", os.path.basename(tmp_filepath)))
