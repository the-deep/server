...
class TestCase(test.APITestCase):
    ...
    def create(self, model, **kwargs):
        ...
        obj = autofixture.base.AutoFixture(
            model, field_values=kwargs, generate_fk=True, follow_fk=False, follow_m2m=False
        ).create_one()
    ...
    def create_project_roles(self):
        ...
        self.smaller_admin_role = ProjectRole.objects.create(
            ...
            lead_permissions=get_project_permissions_value("lead", "__all__"),
            entry_permissions=get_project_permissions_value("entry", "__all__"),
            setup_permissions=get_project_permissions_value("setup", ["modify"]),
            export_permissions=get_project_permissions_value("export", "__all__"),
            assessment_permissions=get_project_permissions_value("assessment", "__all__"),
            is_creator_role=True,
            level=100,
        ...
        self.normal_role = ProjectRole.objects.create(
            ...
            export_permissions=get_project_permissions_value("export", ["create"]),
            assessment_permissions=get_project_permissions_value("assessment", "__all__"),
        ...
        self.view_only_role = ProjectRole.objects.create(
            ...
            assessment_permissions=get_project_permissions_value("assessment", ["view"]),
        )
    ...
    def post_and_check_201(self, url, data, model, fields):
        ...
        self.assertEqual(model.objects.count(), model_count + 1), f"One more {model} should have been created"
    ...
    def create_assessment(self, **fields):
        ...
        return self.create(Assessment, lead=lead, project=lead.project, **fields)
    ...
    def post_filter_test(self, url, filters, count=1, skip_auth=False):
        params = {"filters": [[k, v] for k, v in filters.items()]}
