...
class CacheKey:
    ...
    class ExploreDeep:
        ...
        TOP_TEN_PUBLISHERS = _PREFIX + 'TOP-TEN-PUBLISHERS'
        TOP_TEN_FRAMEWORKS = _PREFIX + 'TOP-TEN-FRAMEWORKS'
        TOP_TEN_PROJECTS_BY_USERS = _PREFIX + 'TOP-TEN-PROJECTS-BY-USERS'
        TOP_TEN_PROJECTS_BY_ENTRIES = _PREFIX + 'TOP-TEN-PROJECTS-BY-ENTRIES'
